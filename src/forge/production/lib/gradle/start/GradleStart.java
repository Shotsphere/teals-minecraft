...
public class GradleStart extends GradleStartCommon {
      ...
      protected void setDefaultArguments(Map<String, String> argumentMap) {
            ...
            argumentMap.put("assetsDir", new File("").getAbsolutePath() + FILE_SEPERATOR + "Minecraft" + FILE_SEPERATOR + "production" + FILE_SEPERATOR + "lib" + FILE_SEPERATOR + "gradle" + FILE_SEPERATOR + "assets");
